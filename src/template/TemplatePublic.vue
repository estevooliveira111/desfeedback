    ...
    <header class="py-10">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <nav class="relative z-50 flex justify-between">
          <div class="flex items-center md:gap-x-12 font-bold">
            <router-link :to="{ name: 'home' }" class="text-2xl">
              <span class="text-primary">Des</span>Feedback</router-link
            >
          ...
          <div class="flex items-center gap-x-5 md:gap-x-8">
            ...
            <div class="-mr-1 md:hidden">
              ...
              <div
                hidden=""
                style="position: fixed; top: 1px; left: 1px; width: 1px; height: 0; padding: 0; margin: -1px; overflow: clip: rect(0, 0, 0, 0); white-space: nowrap; border-width: 0; display: none;"
              ></div>
            </div>
          </div>
        </nav>
